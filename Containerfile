FROM quay.io/fedora/fedora-bootc:43@sha256:5dc10b6a6773a5a6ec46f84d2bd2e859a13dfc1126b2b26899b03a5782cf78f9 AS builder
...
RUN dnf install -y steam solaar && dnf clean all
RUN bootc container lint
